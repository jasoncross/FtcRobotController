...
- Triple-tap reverse latch now ignores forward intake reasserts (including assist restores) so the reverse run stays active until the next intake toggle press or an explicit stop.
