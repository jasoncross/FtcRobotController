...
- Limelight MT2 botpose streams are corner-origin; odometry shifts them to the FTC center-origin frame by subtracting 72 in from both axes before applying calibration offsets.
