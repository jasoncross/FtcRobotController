...
/*
 * FILE: Auto_Blue_Human_Long_Move.java
 ...
 */
@Autonomous(name="Auto: Blue Human Long Move", group="Auto", preselectTeleOp="TeleOp - Blue")
public class Auto_Blue_Human_Long_Move extends BaseAuto {
    ...
    public Auto_Blue_Human_Long_Move() { setStartingPose(-12.0, -63.0, 0.0); }
    ...
    protected void runSequence() throws InterruptedException {
        sequence()
                ...
                .move("Drive forward to clear wall", 6.0, 15.0, 0.0, 1)
                .rotateToTarget("Scan for Tag", ScanDirection.CCW, 0.4, 30, -30, 8000)
                ...
                .move("Drive to balls", 30.0, 105.0, -90.0, 1)
                .run();
    }
}
