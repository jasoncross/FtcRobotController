...
public abstract class BaseAuto extends LinearOpMode {
    ...
    //                        to reuse at startup.
    // CHANGES (2025-12-05): Added AutoSequence.fireContinuous(...) for timed continuous-feed volleys
    //                        that hold the gate open while sustaining launcher RPM.
    // CHANGES (2025-12-10): Corrected AutoSequence.fireContinuous(...) to call the BaseAuto helper
