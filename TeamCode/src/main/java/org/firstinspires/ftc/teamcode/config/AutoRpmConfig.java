...
public final class AutoRpmConfig {
    ...
    public static double NEAR_DIST_IN      = 65.4;  // Authoritative near-shot distance (inches); overrides controller defaults
    public static double NEAR_RPM          = 4550.0; // RPM paired with NEAR_DIST_IN; adjust together after re-scaling range
    public static double FAR_DIST_IN       = 114.0; // Far-shot anchor distance; align with autonomous standoff distances
    public static double FAR_RPM           = 5000.0; // RPM for FAR_DIST_IN; still clamped by Launcher.RPM_MAX
