...
public final class IntakeTuning {
    ...
    // CHANGES (2025-12-05): Added reverse pulse power/duration for the triple-tap RB gesture.
    // CHANGES (2025-12-09): Removed the timed reverse duration in favor of a latched
    //                       reverse mode that exits on the next intake toggle tap.
