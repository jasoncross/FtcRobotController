...
public final class OdometryConfig {
    ...
    public static final double TAG_RED_GOAL_Y       = 130.0;   // Red goal AprilTag center Y, inches
    ...
    public static final double TAG_BLUE_GOAL_Y       = 130;  // Blue goal AprilTag center Y, inches
    ...
    public static final double CLASSIFIER_RED_Y  = 96.0;   // Red classifier center Y
    public static final double CLASSIFIER_BLUE_X = -68.5;    // Blue classifier center X
    public static final double CLASSIFIER_BLUE_Y = 96.0;   // Blue classifier center Y
    ...
    public static final double SECRET_TUNNEL_RED_Y1 = 22.75;      // Red tunnel start Y
    public static final double SECRET_TUNNEL_RED_Y2 = 69.5;      // Red tunnel end Y
    public static final double SECRET_TUNNEL_BLUE_X  = -68.5;     // Blue wall secret tunnel X
    public static final double SECRET_TUNNEL_BLUE_Y1 = 22.75;     // Blue tunnel start Y
    public static final double SECRET_TUNNEL_BLUE_Y2 = 69.5;     // Blue tunnel end Y

    // ==== Loading zones & base zones (inches) ====
    public static final double LOADING_ZONE_RED_CENTER_X  = 60.5; // Red loading zone center X
    public static final double LOADING_ZONE_RED_CENTER_Y  = 11.5;  // Red loading zone center Y
    public static final double LOADING_ZONE_BLUE_CENTER_X = -60.5;  // Blue loading zone center X
    public static final double LOADING_ZONE_BLUE_CENTER_Y = 11.5;  // Blue loading zone center Y
    ...
    public static final double BASE_ZONE_RED_CENTER_Y  = 33.5;     // Red base zone center Y
    public static final double BASE_ZONE_BLUE_CENTER_X = 33.5;     // Blue base zone center X
    public static final double BASE_ZONE_BLUE_CENTER_Y = 33.5;     // Blue base zone center Y
