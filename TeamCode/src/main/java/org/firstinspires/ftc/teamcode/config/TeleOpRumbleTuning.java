/** Retained aim-feedback and toggle-confirmation envelopes. See docs/reusable-foundation.md. */
...
public final class TeleOpRumbleTuning {
    ...
    public static double  AIM_STRENGTH_MIN     = 0.10;  // Minimum rumble strength at the edge of the threshold
    public static double  AIM_STRENGTH_MAX     = 0.65;  // Maximum rumble strength near zero heading error
