...
## Revision History
- **2025-12-09** – Latched the triple-tap RB gesture so the intake now runs in reverse until
  ...
  helper, and updated controller layout/help text to match the new reverse workflow.
