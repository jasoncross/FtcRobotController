...
## Revision History
- **2025-12-31** – Enforced single-source odometry updates per Auto loop, saved the final fused pose with a cached update for TeleOp handoff, and cleaned up TeleOp INIT pose formatting.
