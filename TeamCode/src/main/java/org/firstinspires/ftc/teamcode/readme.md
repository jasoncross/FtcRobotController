...
## Revision History
- **2025-12-31** – Allowed mixed goal+obelisk MT2 frames to fuse under cautious clamps while still rejecting obelisk-only/primary solves, enforced single-source Auto odometry updates, saved the final fused pose for TeleOp handoff, and cleaned up TeleOp INIT pose formatting.
