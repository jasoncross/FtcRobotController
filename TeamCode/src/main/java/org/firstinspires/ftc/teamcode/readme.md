...
AutoSequence builder labels now populate a dedicated `Sequence Step` telemetry
line alongside the existing `Phase` entry so drivers can see the exact scripted
