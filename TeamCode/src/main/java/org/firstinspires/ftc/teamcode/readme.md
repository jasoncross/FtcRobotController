...
└── src/main/java/org/firstinspires/ftc/teamcode/
    ...
    │   ├── TeleOpDriverDefaults.java         ← Driver preferences, manual ranges, and firing stats thresholds
...
## Revision History
- **2026-01-04** – Updated debug firing stats to time drops from feed motor engagement using a tunable RPM drop trigger, measure recovery back to full target RPM, and window the idle variance telemetry with a new tunable; documentation updated to match.
