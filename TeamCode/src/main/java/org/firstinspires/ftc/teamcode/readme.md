...
## Revision History
- **2025-12-19** – Treated alliance-goal fiducial detections as valid for aiming/telemetry even when the Limelight result flags itself invalid, so Tag Visible readouts and goal-only heading/range samples stay live whenever tag 20/24 appears.
