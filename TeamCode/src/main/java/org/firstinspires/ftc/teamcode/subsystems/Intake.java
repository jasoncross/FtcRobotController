 ...
 * CHANGES (2025-12-05): Added reverse pulse support for a triple-tap RB gesture in
 *                       TeleOp to clear jams without reconfiguring tunables.
 * CHANGES (2025-12-09): Converted the reverse pulse into a latched reverse mode
