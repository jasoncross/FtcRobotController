 ...
 * CHANGES (2025-12-05): Added a triple-tap RB gesture that runs an intake reverse
 *                       pulse without disrupting the existing intake toggle.
 * CHANGES (2025-12-09): Latched the triple-tap RB gesture into a continuous reverse
