...
public class VisionAprilTag {
    ...
    private void applyProfileInternal(VisionTuning.Profile next, VisionTuning.Mode mode) {
        ...
        try { tagBuilder.setDecimation(next.decimation); } catch (Throwable ignored) {}
    ...
    private void applyLiveViewState() {
        ...
        try {
            portal.setLiveViewEnabled(liveViewRequested);
            applied = true;
            ...
            try {
                ...
                try {
                    ...
                    if (liveViewRequested) {
                        try { portal.resumeStreaming(); applied = true; } catch (Throwable ignored4) {}
                    }
                }
            }
        }
    ...
    private void trySetDistortion(AprilTagProcessor.Builder builder,
        ...
        try {
            builder.setDistortionCoefficients(k1, k2, p1, p2, k3);
        } catch (Throwable ignored) {
