 ...
 *                        different fields without changing callers.
 */
public class VisionAprilTag {
    ...
    private void applyProfileInternal(VisionTuning.Profile next, VisionTuning.Mode mode) {
        ...
        try { tagBuilder.setImageProcessor(brightnessNormalizer); } catch (Throwable ignored) {}
    ...
    private static final class BrightnessNormalizer implements AprilTagProcessor.ImageProcessor {
